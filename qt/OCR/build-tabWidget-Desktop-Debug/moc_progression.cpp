...
#include "../tabWidget/progression.h"
...
static const char qt_meta_stringdata_Progression[] = {
    "Progression\0"
};
...
const QMetaObjectExtraData Progression::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Progression::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Progression,
      qt_meta_data_Progression, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Progression::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Progression))
